...
describe(`aip endpoints`,()=>{
    ...
    before('clean the table', () => db.raw('TRUNCATE aip_bookmarks, aip_posts, aip_users RESTART IDENTITY CASCADE'))

    afterEach('cleanup',() => db.raw('TRUNCATE aip_bookmarks, aip_posts, aip_users RESTART IDENTITY CASCADE'))
